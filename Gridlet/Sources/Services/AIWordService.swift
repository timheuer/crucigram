...
struct GeneratedWordClue: Equatable {
    @Guide(description: "A single common English word, 3 to 6 letters, uppercase, letters only, no proper nouns")
    var word: String
...
final class AIWordService: Sendable {
    ...
    func generateWordClues(count: Int, maxLength: Int, seed: UInt64) async -> [WordClue] {
        ...
        do {
            ...
            let prompt = "Generate \(count) unique crossword word-clue pairs with words of \(3)-\(maxLength) letters."
